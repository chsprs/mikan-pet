...
class PetControllerTests(unittest.TestCase):
    ...
    def test_walk_clamps_and_reverses_at_left_edge(self) -> None:
        ...
        self.assertEqual(Point(0, 40), controller.state.position)
        self.assertEqual(Direction.RIGHT, controller.state.direction)
